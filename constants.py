...
TWEAKS = {
    ...
    'ahe_mi24_Rudder' : [
        ...
        #'ObjectTemplate.setWingLift 7.5',
    ...
    'nl_apc_cv90_zmotor' : [
        #'ObjectTemplate.setMinRotation 0/0/0',
        #'ObjectTemplate.setMaxRotation 1/0/1500',
        #'ObjectTemplate.setMaxSpeed 2/0/8',
        #'ObjectTemplate.setAcceleration 50/0/200',
        #'ObjectTemplate.setTorque 150',
        #'ObjectTemplate.setDifferential 22',
        #'ObjectTemplate.setNumberOfGears 5',
        ],
    'nl_apc_cv90_camera_commander' : [
        #'ObjectTemplate.CVMChase 1',
        #'ObjectTemplate.CVMFrontChase 0',
        #'ObjectTemplate.CVMFlyBy 1',
        #'ObjectTemplate.chaseDistance 12.25',
        #'ObjectTemplate.chaseAngle 0.1',
        #'ObjectTemplate.chaseOffset 4/0/4.5',
        #'ObjectTemplate.postProcess.tvDistortionFreq 0.0',
        #'ObjectTemplate.postProcess.tvDistortionRoll 0.0',
        #'ObjectTemplate.postProcess.tvInterference 0.2',
        ],
